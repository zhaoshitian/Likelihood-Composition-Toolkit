...
for ds in mmbench_dev 
do
for modelpath in ${path15}
do
python /home/ubuntu/stzhao/LiCo/inference.py \
    --model-path ${modelpath} \
    --ds ${ds} \
    --conv-mode mm_default \
    --cuda "0,1,4,5,6,7" \
    --batchsize 1 \
    --multi_choices True \
...
# for ds in pope_adversarial pope_popular pope_random
# do
# for modelpath in ${path8}
# do
# python /home/ubuntu/stzhao/LiCo/inference.py \
#     --model-path ${modelpath} \
#     --ds ${ds} \
...
# for ds in mme vsr pope_adversarial pope_random pope_popular
# do
# for modelpath in ${path7} ${path8}
# do
# python /home/ubuntu/stzhao/LiCo/inference.py \
#     --model-path ${modelpath} \
#     --ds ${ds} \
...
# for ds in mmvp mmbench_dev vqav2_val vizwiz_val gqa_testdev winoground clevr scienceqa_test
# do
# for modelpath in ${path7} ${path8}
# do
# python /home/ubuntu/stzhao/LiCo/inference.py \
